                    ...
                    <div className='col-span-6 flex flex-col gap-8 '>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            <Icon
                                ...
                                className="text-accent text-xl inline-block me-2"
                            />
                            <p className='text-accent text-sm font-semibold text-center lg:text-start'>Get 30% off on first enroll</p>
                        </div>
                        <h1 className='text-midnight_text text-4xl sm:text-5xl font-semibold pt-5 lg:pt-0'>Guiding You Toward a Brighter Future</h1>
                        <h3 className='text-black/70 text-lg pt-5 lg:pt-0'>Learn from certified mentors and globally trusted universities.</h3>
